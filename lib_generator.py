...
if len(sys.argv) != 3:
    print(sys.argv)
    raise Exception("Usage: python ./lib_generator.py input_path output_path")
...
from lib_gen import _write_structure
from lib_gen import _write_comps
from lib_gen import _copy_policies
from lib_gen import _util
import __SETTINGS__
